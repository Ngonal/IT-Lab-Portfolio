...
| 3 | Links are now up with active LEDs | Tested communication using `ping` via Windows Command Prompt | Communication successful - saved configuration with `write` | <img src="Elements/Step3.png"> |
