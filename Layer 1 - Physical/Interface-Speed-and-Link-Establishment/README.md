...
| 3 | Both hosts are now able to communicate | Saved configuration with `write` — tested communication `ping` via Windows Command Prompt | Communication successful | <img src="Elements/Step3.png"> |
