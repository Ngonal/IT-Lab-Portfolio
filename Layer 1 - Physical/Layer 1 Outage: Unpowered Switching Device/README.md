...
|:---|:---|:---|:---|:---:| 
| 1 | Verified electrical outlet working using another device, `SW1` is plugged into electrical outlet, `SW1` power switch is in the **OFF** position | Toggled power switch to **ON** | `Fa0/2` LEDs illuminate; `Fa0/1` remains dark | <img src="Elements/Step1.png"> |
