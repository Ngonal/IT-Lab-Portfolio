...
|:---:|:---|:---|:---|:---:| 
| 1 | Verified electrical outlet is working using a known-good device (receptable tester/phone charger connected to phone), `SW1` is plugged into electrical outlet, reconnected power cable, `SW1` power switch is in the **OFF** position | Toggled power switch to **ON** | `Fa0/2` LEDs illuminate; `Fa0/1` remains dark | <img src="Elements/Step1.png"> |
