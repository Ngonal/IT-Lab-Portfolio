...
|:---|:---|:---|:---|:---:| 
| 1 | Verified electrical outlet working using another device, Switch is plugged into electrical outlet, Switch power switch is in the **OFF** position | Toggled power switch to **ON** | `Fa0/2` LEDs illuminate; `Fa0/1` remains dark | <img src="Elements/Step1.png"> |
