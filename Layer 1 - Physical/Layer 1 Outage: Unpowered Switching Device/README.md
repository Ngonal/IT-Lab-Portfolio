...
| 2 | Cable connectting `PC1` to `Fa0/1` on `SW1` is disconnected | Reconnected cable to `Fa0/1` | No change; `Fa0/1` LEDs remain unilluminated | <img src="Elements/Step2.png"> |
