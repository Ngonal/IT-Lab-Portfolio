...
| 4 | Both hosts appear to have link connectivity according to their blinking interface LEDs | Tested communication using `ping` via Windows Command Prompt | Communication successful — `write` executed to save configurations on all updated devices. | <img src="Elements/Step4.png"> |
